...
public class Router : MonoBehaviour , NetworkDevice
{
    ...
    //private variables
    public string enabledModePassword = "";
    public string userModePassword = "";
    public bool needUserPassword = false;
    public bool needEnPassword = false;
